...
const ADDITIONAL_EXPRESSION_NAMES = [
  'Sarah Chen', 'James Wilson', 'Emma Roberts', 'Alex Turner', 'Wellness Hub',
  'Mind Matters', 'Calm Studios', 'Nature Sounds', 'Mike Chen', 'Luna Park',
  'David Lee', 'Zen Garden', 'Hope Rising', 'Olivia Green', 'Noah Martinez',
  'Sophia Kim', 'Ethan Cole', 'Ava Johnson', 'Liam Brown', 'Mia Davis',
];

const ADDITIONAL_EXPRESSION_AVATARS = [
  ...
  'https://images.unsplash.com/photo-1529626455594-3ff2642d6b58?w=200&h=200&fit=crop',
  'https://images.unsplash.com/photo-1554151228-14d4e2c5c4a5?w=200&h=200&fit=crop',
  'https://images.unsplash.com/photo-1502823404699-e3a36dbb2374?w=200&h=200&fit=crop',
  'https://images.unsplash.com/photo-1568602471122-7832953d6d9c?w=200&h=200&fit=crop',
  'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=200&h=200&fit=crop',
  'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&h=200&fit=crop',
];

const ADDITIONAL_EXPRESSION_CAPTIONS = [
  'Morning gratitude practice ✨ Starting the day with intention',
  'Nature walks are my therapy 🌿 #mindfulness',
  'One step at a time. Progress, not perfection 💪',
  'Finding peace in the little moments',
  'Self-care Sunday vibes 🧘‍♀️',
  'Grateful for this community 🙏 #wellbeing',
  'New week, new intentions 🌅',
  'Taking time to breathe today 🌬️',
  'Small wins matter 🏆',
  'Choose kindness, always 💙',
  'Reflecting on growth this month 🌱',
  'Sunset therapy 🌅 #calm',
  'Monday mindset: progress over perfection',
  'Finding joy in simplicity 🕊️',
  'Healing isn\'t linear, and that\'s okay',
  'Coffee and journaling ☕📓',
  'Body scan meditation done ✔️',
  'Weekend wind-down routine',
...
const createInitialExpressions = (): FeedExpression[] => {
  ...
  const additional: FeedExpression[] = Array.from({ length: 24 }, (_, i) => {
    const avatar = ADDITIONAL_EXPRESSION_AVATARS[i % ADDITIONAL_EXPRESSION_AVATARS.length];
    return {
      id: generateMockUUID(),
      userId: generateMockUUID(),
      userName: ADDITIONAL_EXPRESSION_NAMES[i % ADDITIONAL_EXPRESSION_NAMES.length],
      userAvatar: avatar,
      mediaUrl: avatar.replace('w=200&h=200', 'w=400&h=700'),
      mediaType: 'image' as const,
      caption: ADDITIONAL_EXPRESSION_CAPTIONS[i % ADDITIONAL_EXPRESSION_CAPTIONS.length],
      hasUnseenExpression: i % 3 !== 0,
      createdAt: new Date(Date.now() - (i + 1) * 45 * 60 * 1000),
      expiresAt: new Date(Date.now() + (18 + (i % 12)) * 60 * 60 * 1000),
    };
  });
